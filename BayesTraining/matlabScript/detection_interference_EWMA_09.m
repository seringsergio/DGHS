...
% Para graficar 
mean_error_int_vec_EWMA_09 = mean(error_int_vec_EWMA_09);
std_error_int_vec_EWMA_09 = std(error_int_vec_EWMA_09);

mean_percentage_det_int_vec_EWMA_09 = mean(percentage_det_int_vec_EWMA_09); 
std_percentage_det_int_vec_EWMA_09 = std(percentage_det_int_vec_EWMA_09);

% Identificar donde el error es menor de 1% (porcent_value)
where_error_int_vec_EWMA_09 = (error_int_vec_EWMA_09 <= porcent_value); % identificar valores menores a 1%
where_error_int_vec_EWMA_09 = double(where_error_int_vec_EWMA_09); % convertir los valores de logical a double
where_error_int_vec_EWMA_09(where_error_int_vec_EWMA_09 == 0) = NaN;% convertir los Zeros en NaN
where_error_int_vec_EWMA_09(where_error_int_vec_EWMA_09 == 1) = 0; % convertir los 1 en zeros
