...
title('Backoff time per packet', 'FontSize', 30, 'fontweight','bold');

subplot(10,1,4:10);

plot(int_vec_0_100, EWMA1_mean_btp_01_vec,'b-o','LineWidth',4)
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
xlabel('Level of interference (%)','FontSize', 28,'fontweight','bold');
ylabel('Backoff time (ms)','FontSize', 28,'fontweight','bold');
...
ylabel('Std','FontSize', 28,'fontweight','bold');
title('Percentage of packets dropped', 'FontSize', 30, 'fontweight','bold');
...
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
xlabel('Level of interference (%)','FontSize', 28,'fontweight','bold');
ylabel('Packets dropped (%)','FontSize', 28,'fontweight','bold');
...
ylabel('Std','FontSize', 28,'fontweight','bold');
title('Accuracy of the naive Bayes classifier', 'FontSize', 30, 'fontweight','bold');
...
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
xlabel('α','FontSize', 28,'fontweight','bold');
ylabel('Accuracy (%)','FontSize', 28,'fontweight','bold'); 
%legenda1 = 'Bayesian detector';
%legenda2 = 'Ideal detector';
%legenda =legend(legenda1,legenda2,'Location','SouthEast');
%set(legenda,'FontSize',14);
...
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_01_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
plot(int_vec_0_100, where_error_int_vec_EWMA_01_wind_10, 'ks', 'MarkerFaceColor', 'r', 'MarkerSize',10, 'LineWidth',2)
set(gca,'fontsize',20) % Colocar mas grandes los numeros de los ejes
set(gca,'YTick',-5:10:5); % para que el eje Y vaya de 10 en 10...desde -5 hasta 5
% set(gca,'XTickLabel',{}) % quitar los numeros en el eje x
xlim([0 100]);
ylim([min(error_int_vec_EWMA_01_wind_10*-1)-2.00 max(error_int_vec_EWMA_01_wind_10)+2.00 ]);
ylabel('0.1','FontSize', 28,'fontweight','bold');
xlabel('Level of interference (%)','FontSize', 28,'fontweight','bold');
subplot(18,1,15:16);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_02_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_02_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
plot(int_vec_0_100, where_error_int_vec_EWMA_02_wind_10, 'ks', 'MarkerFaceColor', 'r', 'MarkerSize',10, 'LineWidth',2)
set(gca,'fontsize',20) % Colocar mas grandes los numeros de los ejes
set(gca,'YTick',-10:20:10); % para que el eje Y vaya de 20 en 20...desde -10 hasta 10
set(gca,'XTickLabel',{}) % quitar los numeros en el eje x
xlim([0 100]);
ylim([min(error_int_vec_EWMA_02_wind_10*-1)-2.00 max(error_int_vec_EWMA_02_wind_10)+2.00 ]);
ylabel('0.2','FontSize', 28,'fontweight','bold');
subplot(18,1,13:14);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_03_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_03_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.3','FontSize', 28,'fontweight','bold');
subplot(18,1,11:12);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_04_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_04_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.4','FontSize', 28,'fontweight','bold');
subplot(18,1,9:10);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_05_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_05_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.5','FontSize', 28,'fontweight','bold');
subplot(18,1,7:8);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_06_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_06_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.6','FontSize', 28,'fontweight','bold');
subplot(18,1,5:6);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_07_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_07_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.7','FontSize', 28,'fontweight','bold');
subplot(18,1,3:4);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_08_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_08_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.8','FontSize', 28,'fontweight','bold');
subplot(18,1,1:2);
h1  = errorbar(int_vec_0_100,vec_zeros,error_int_vec_EWMA_09_wind_10,'b-','LineWidth',4);
text(xtext1,ytext1,num2str(mean_error_int_vec_EWMA_09_wind_10,'%.1f'),'FontSize', 28, 'fontweight','bold');
text(xtext1,ytext2,'avg','FontSize', 28, 'fontweight','bold');
text(xtext2,ytext2,'α','FontSize', 28, 'fontweight','bold');
hold on
...
ylabel('0.9','FontSize', 28,'fontweight','bold');
title('Error of the naive Bayes classifier', 'FontSize', 30, 'fontweight','bold');
...
ylabel('Power (mW)','FontSize', 28,'fontweight','bold');
xlabel('Window size','FontSize', 28,'fontweight','bold');
title('Power consumption', 'FontSize', 30, 'fontweight','bold');
legenda1 = 'cpu';
legenda2 = 'lpm';
legenda3 = 'Tx';
legenda4 = 'Rx';
...
title('TX Power consumption', 'FontSize', 30, 'fontweight','bold');
...
title('RX Power consumption', 'FontSize', 30, 'fontweight','bold');
...
title('CPU Power consumption', 'FontSize', 30, 'fontweight','bold');
...
title('LPM Power consumption', 'FontSize', 30, 'fontweight','bold');
...
ylabel('Power (mW)','FontSize', 28,'fontweight','bold');
xlabel('Mechanism','FontSize', 28,'fontweight','bold');
title('Power consumption', 'FontSize', 30, 'fontweight','bold');
legenda1 = 'cpu';
legenda2 = 'lpm';
legenda3 = 'Tx';
...
text(xtext1,ytext1,'CITT','FontSize', 28, 'fontweight','bold');
ylabel('Std','FontSize', 28,'fontweight','bold');
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
set(gca,'XTickLabel',{}) % quitar los numeros en el eje x
...
set(gca,'ytick',-0.4:0.8:+0.4) % para q muestre en el eje numeros desde -0.4 hasta +0.4, en intervalos de 0.4
title('RX Power consumption', 'FontSize', 30, 'fontweight','bold');
subplot(10,1,3:4);
h1  = errorbar(int_vec_0_100,vec_zeros,consolidado_listen_rpl_leaf_int_x_mW_std,'r-o','LineWidth',4);
set(gca,'YTick',-0.2:0.4:0.2); % para que el eje Y vaya de 10 en 10...desde -5 hasta 5
text(xtext1,ytext1,'RPL','FontSize', 28, 'fontweight','bold');
ylabel('Std','FontSize', 28,'fontweight','bold');
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
set(gca,'XTickLabel',{}) % quitar los numeros en el eje x
xlim([min(int_vec_0_100) max(int_vec_0_100)]);
...
figure
label_mech={'RPL'; 'CITT' };
bar([PRR_RPL_int_0 PRR_citt_int_0],'FaceColor',color_4)
ylabel('PRR (%)','FontSize', 28,'fontweight','bold');
title('Packet Reception Rate (PRR)', 'FontSize', 30, 'fontweight','bold');
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
set(gca,'xticklabel',label_mech)
...
label_mech={'RPL'; 'CITT' };
hold on
bar(1:2,[latency_RPL_int_0_vec_mean latency_citt_int_0_vec_mean],'FaceColor',color_4)
% Esta funcion (terrorbar) la descargue de internet para variar la longitud
% del errorbar. Width. CapSize. 
% Ref: https://la.mathworks.com/matlabcentral/fileexchange/52367-terrorbar-m-error-bars-with-controlled-widths-post-r2014b
...
terrorbar(1:2,[latency_RPL_int_0_vec_mean latency_citt_int_0_vec_mean], [latency_RPL_int_0_vec_mean latency_citt_int_0_vec_std],0.7,'centi');
ylabel('Latency (us)','FontSize', 28,'fontweight','bold');
title('End-to-end latency', 'FontSize', 30, 'fontweight','bold');
set(gca,'fontsize',24) % Colocar mas grandes los numeros de los ejes
