...
all_cpu_wind_30_diff_int_0 = all_cpu_wind_30_diff_int_0( all_cpu_wind_30_diff_int_0>=0 );
all_lpm_wind_30_diff_int_0 = all_lpm_wind_30_diff_int_0( all_lpm_wind_30_diff_int_0>=0 );
all_transmit_wind_30_diff_int_0 = all_transmit_wind_30_diff_int_0( all_transmit_wind_30_diff_int_0>=0 );
all_listen_wind_30_diff_int_0 = all_listen_wind_30_diff_int_0( all_listen_wind_30_diff_int_0>=0 );

% Hacer los vectores del mismo tamaño. Del minimo tamaño.

minLength = min( [length(all_cpu_wind_30_diff_int_0),length(all_lpm_wind_30_diff_int_0),length(all_transmit_wind_30_diff_int_0),length(all_listen_wind_30_diff_int_0)]   );

all_cpu_wind_30_diff_int_0 = all_cpu_wind_30_diff_int_0(1:minLength);
all_lpm_wind_30_diff_int_0 = all_lpm_wind_30_diff_int_0(1:minLength);
all_transmit_wind_30_diff_int_0 = all_transmit_wind_30_diff_int_0(1:minLength);
all_listen_wind_30_diff_int_0 = all_listen_wind_30_diff_int_0(1:minLength);
