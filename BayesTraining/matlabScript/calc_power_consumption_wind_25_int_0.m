...
all_cpu_wind_25_diff_mW_int_0 = all_cpu_wind_25_diff_int_0 * current_CPU_remote * voltage_remote / rtimer_second_remote / powertrace_period_basictree;
all_lpm_wind_25_diff_mW_int_0 = all_lpm_wind_25_diff_int_0 * current_LPM_remote * voltage_remote / rtimer_second_remote / powertrace_period_basictree;
all_transmit_wind_25_diff_mW_int_0 = all_transmit_wind_25_diff_int_0 * current_TX_remote_0_dBm * voltage_remote / rtimer_second_remote / powertrace_period_basictree;
all_listen_wind_25_diff_mW_int_0 = all_listen_wind_25_diff_int_0 * current_RX_remote * voltage_remote / rtimer_second_remote / powertrace_period_basictree;
