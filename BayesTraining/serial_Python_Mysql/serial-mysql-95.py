...
device = '/dev/ttyUSB7' #this will have to be changed to the serial port you are using
try:
  print "Trying...",device
...
while True:
 ...
 try:
   ...
   if pieces[0] in ['CSMA']:
       ...
       try:
          cursor.execute("INSERT INTO int_95_tx (id,num_packets,btp,EWMA_btp_09,EWMA_btp_08,\
